      ...
      <CardHeader className="relative z-10 pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Button
            ...
            className="bg-white hover:bg-white/90 text-ls-heading border-0 rounded-[32px] h-10 px-4 sm:px-6 font-semibold shadow-md hover:shadow-lg transition-all shrink-0"
          >
            Voir les détails
