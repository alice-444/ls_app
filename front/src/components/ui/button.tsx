	...
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
	{
		variants: {
			variant: {
				...
				/** CTA succès (accepter) – vert avec relief */
				ctaSuccess: `${ctaRelief} bg-emerald-600/95 dark:bg-emerald-600/90 border border-emerald-400/50 dark:border-emerald-500/40 text-white font-semibold hover:bg-emerald-600 hover:border-emerald-400/70 hover:shadow-[0_10px_30px_-8px_rgba(5,150,105,0.4),0_6px_12px_-4px_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.2)] dark:hover:bg-emerald-500 dark:hover:border-emerald-400/60 dark:hover:shadow-[0_10px_30px_-8px_rgba(5,150,105,0.45),inset_0_2px_0_0_rgba(255,255,255,0.1)]`,
				/** CTA destructif (rejet) – style navbar avec relief */
				ctaDestructive: `${ctaRelief} bg-destructive/95 dark:bg-destructive/85 border border-red-200/60 dark:border-red-500/40 text-white font-semibold hover:bg-destructive hover:border-red-300 hover:shadow-[0_10px_30px_-8px_rgba(220,38,38,0.35),0_6px_12px_-4px_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.2)] dark:hover:bg-destructive dark:hover:border-red-500/60 dark:hover:shadow-[0_10px_30px_-8px_rgba(220,38,38,0.45),inset_0_2px_0_0_rgba(255,255,255,0.1)]`,
			},
			size: {
