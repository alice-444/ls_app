  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[16px]">
      <div className="flex flex-col gap-[16px] w-full lg:w-[300px] shrink-0">
        <Card className="relative overflow-hidden bg-linear-to-br from-[#26547c] to-[#4A90E2] border-0 text-white">
          <CardContent className="p-8">
            ...
            <div className="flex items-end gap-4 mb-6">
              <p className="text-[32px] font-medium leading-none">
                ...
                <span className="text-[18px]">crédit(s)</span>
              </p>
          ...
          <Card className="border border-[#d6dae4] rounded-[16px] bg-white">
            <CardContent className="p-8">
              ...
              <div className="flex items-center justify-between gap-4 mb-8">
                ...
                <Button
                  variant="outline"
                  className="border border-[#d6dae4] rounded-[32px] h-10 px-4 py-2 text-base font-semibold text-[#26547c] flex items-center gap-2 shrink-0 bg-white"
                ...
                {workshopRequests.map((request: any) => (
                  ...
                  >
                    ...
                    request.status === "REJECTED" ? (
                      ...
                      <Button
                        variant="outline"
                        className="border border-[#d6dae4] rounded-[32px] h-10 px-4 py-2 text-base font-semibold text-[#26547c] flex items-center gap-2 shrink-0"
                        onClick={() => {
                          if (
                            confirm(
