...
- Documentation dans `ai_docs/docs/` (architecture, services, patterns, database, components)
...
project/
├── ai_docs/
│   ├── PRD/                       # Cahier des charges (découpé)
│   ├── EPTC/                      # Plan tests E2E (découpé)
│   ├── gemini/                    # Index + exemples de prompts
│   ├── docs/                      # Doc technique (architecture, services, patterns, etc.)
│   └── gemini-context.md
├── concept_library/
│   └── cc_PRP_flow/
...
│       └── PRPs/
│           ├── base_template_v1.md
└── docs/                          # Doc technique du repo (racine)
```
