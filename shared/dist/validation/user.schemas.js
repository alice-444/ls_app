...
exports.updatePublicProfileSchema = zod_1.z.object({
    name: zod_1.z.string().min(1, "Le nom est requis").max(120, "Le nom est trop long").optional(),
    bio: zod_1.z.string().max(300, "La bio ne doit pas dépasser 300 caractères").nullable().optional(),
